...
knitr::include_graphics("images/ex-neuroscience.png")
```

.tiny[
Source: https://journals.plos.org/plosone/article/figure?id=10.1371/journal.pone.0008694.g003
]
...
knitr::include_graphics("images/ex-phds.jpeg")
```

.tiny[
Source: https://twitter.com/W_R_Chase/status/1097892040350855179
]
...
```{r echo=FALSE, out.width=750}
knitr::include_graphics("images/ex-econ-phds.jpeg")
```

.tiny[
Source: https://twitter.com/toddrjones/status/1165038157353668609
]
...
- Colors should use a categorical palette 
...
- Better as a mosaic?
- Not showing flow from one state to another
...
```{r echo=FALSE, out.width=400}
knitr::include_graphics("images/ex-vaccines.jpeg")
```
.tiny[
Source: https://twitter.com/FBaudron/status/1405253206263877636
]
...
```{r echo=FALSE, out.width=600}
knitr::include_graphics("images/ex-got.png")
```
...
```{r echo=FALSE, out.width=600}
knitr::include_graphics("images/ex-got-2.png")
```

.tiny[
Source: https://medium.com/@matthewlunkes/a-game-of-data-visualizations-243c3d8ceb1e
]
...
- May be better to use colors across the entire graph
- A lot going on here but may be good given the audience 
